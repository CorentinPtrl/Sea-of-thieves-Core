...
public:
	...
	{
		cData cRead;
		ReadProcessMemory(Core::memoryProcess, (LPVOID)dwAddress, &cRead, sizeof(cData), NULL);
		return cRead;
	}
	...
	{
		WriteProcessMemory(Core::memoryProcess, (LPVOID)dwAddress, &write, sizeof(cData), NULL);
	}
